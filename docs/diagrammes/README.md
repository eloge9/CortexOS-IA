...
Tous les diagrammes sont en mode B (D-46) : Claude les écrit, Eloge les relit, doit savoir les expliquer et répond à une question de compréhension.
...
| DIAG-2 | Cas d'utilisation : [par acteur](diag-02a-cas-utilisation-par-acteur.md) · [vue d'ensemble](diag-02b-cas-utilisation-vue-ensemble.md) | S1 | B | À relire par Eloge |
| DIAG-3 | Classes de domaine | S2 | B | À faire |
